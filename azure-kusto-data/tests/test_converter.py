...
from azure.kusto.data._kusto_client import _KustoResultRow
...
class ConverterTests(unittest.TestCase):
    ...
    def test_to_timestamp(self):
        ...
        # Test None
        self.assertIsNone(_KustoResultRow.to_timedelta(None))
    ...
    def test_to_timestamp_fail(self):
        ...
        """
        self.assertRaises(ValueError, _KustoResultRow.to_timedelta, "")
        self.assertRaises(ValueError, _KustoResultRow.to_timedelta, "foo")
        self.assertRaises(ValueError, _KustoResultRow.to_timedelta, "00")
        self.assertRaises(ValueError, _KustoResultRow.to_timedelta, "00:00")
        self.assertRaises(ValueError, _KustoResultRow.to_timedelta, "03.00:00:00.")
        self.assertRaises(ValueError, _KustoResultRow.to_timedelta, "03.00:00:00.111a")

    def test_to_datetime(self):
        """ Tests datetime read by KustoResultIter """
        self.assertIsNone(_KustoResultRow.to_datetime(None))
        self.assertIsNotNone(_KustoResultRow.to_datetime("2016-06-07T16:00:00Z"))

    def test_to_datetime_fail(self):
        """ Tests that invalid strings fails to convert to datetime """
        self.assertRaises(ValueError, _KustoResultRow.to_datetime, "invalid")
