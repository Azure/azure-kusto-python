...
class QueuedIngestClient(BaseIngestClient):
    ...
    def ingest_from_file(self, file_descriptor: Union[FileDescriptor, str], ingestion_properties: IngestionProperties) -> IngestionResult:
        ...
        with descriptor.open(should_compress) as stream:
            blob_descriptor = QueuedIngestClient._upload_blob(containers, descriptor, ingestion_properties, stream, self._blob_client_kwargs)
    ...
    def ingest_from_stream(self, stream_descriptor: Union[StreamDescriptor, IO[AnyStr]], ingestion_properties: IngestionProperties) -> IngestionResult:
        ...
        blob_descriptor = QueuedIngestClient._upload_blob(containers, stream_descriptor, ingestion_properties, stream_descriptor.stream, self._blob_client_kwargs)
    ...
    def _upload_blob(
        ...
        stream: IO[AnyStr],
        blob_client_kwargs: Optional[dict]
    ) -> BlobDescriptor:
        ...
        try:
            blob_service = BlobServiceClient(random_container.account_uri, **blob_client_kwargs)
