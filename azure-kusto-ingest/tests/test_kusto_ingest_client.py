...
class TestQueuedIngestClient:
    ...
    def test_containers(self):
        ...
        containers_by_storage_account = ResourceManager._group_resources_by_storage_account(containers)
        ...
        containers_by_storage_account_for_empty = ResourceManager._group_resources_by_storage_account(containers_empty)
