...
class _AadHelper:
    ...
    def __init__(self, kcsb: "KustoConnectionStringBuilder", is_async: bool):
        ...
        elif kcsb.is_cred_auth:
            self.token_provider = AzureIdentityTokenProvider(
                self.kusto_uri,
                is_async=is_async,
                cred_builder=kcsb.cred_builder,
                async_cred_builder=kcsb.async_cred_builder,
                additional_params=kcsb.cred_params,
            )
